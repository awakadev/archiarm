...
function initMonolit() {
  'use strict'
  // Owl carousel ------------------
  let ss = $('.single-slider'), dlt2 = ss.data('loppsli')
  ss.owlCarousel({
    margin: 0,
    items: 1,
    smartSpeed: 1300,
  ...
  let sync1 = $('.hero-wrap-image-slider'), sync2 = $('.hero-wrap-text-slider'), flag = false, duration = 1300,
  ...
  let gR = $('.gallery_horizontal'), w = $(window), cf = $('.gallery_horizontal').data('cen')

  function initGalleryhorizontal() {
    let a = $(window).height(), b = $('header').outerHeight(), c = $('.gallery_horizontal'),
    ...
    if (w.width() > 1036) gR.owlCarousel({
      ...
      onInitialized: function () {
        ...
        let c = $('.owl-carousel').find('.active').find('.horizontal_item')
        let e = c.data('phdesc')
        let f = c.data('phname')
  ...
  gR.on('translated.owl.carousel', function (a) {
    let b = $(this).find('.active').find('.horizontal_item').data('phdesc')
    let c = $(this).find('.active').find('.horizontal_item').data('phname')
    if (b) $('.caption').html('<h4>' + c + '</h4><p>' + b + '</p>')
  })

  let timestamp_mousewheel = 0
  ...
  let gf = $('.full-screen-gallery'), w2 = $(window)

  function initGalleryFullscreen() {
    let a = $(window).height(), b = $('.full-screen-gallery'), c = $('.control-panel').outerHeight(),
      d = $('.resize-carousel-holder').outerHeight(), e = $('.full-screen-gallery .full-screen-item')
    b.css({
      height: d - c
    })
    e.css({
  ...
  let $lg = $('.lightgallery'), dlt = $lg.data('looped')
  $lg.lightGallery({
  ...
  let ts = $('.show-thumbs').data('textshow')
  let th = $('.show-thumbs').data('texthide')
  $('.show-thumbs').text(ts)
  ...
  function a() {
    ...
    let a = $(window).height(), b = $('header').outerHeight(), c = $('.p_horizontal_wrap')
    c.css('height', a - b - 30)
    let d = $(window).width()
  ...
  function k(a) {
    $('.stats .num').each(function () {
      let b = $(this)
      let c = b.attr('data-num')
      let d = b.attr('data-content')
      number(c, d, b, a)
    })
  }
  ...
  $(document.body).on('appear', '.piechart-holder', function () {
    $(this).find('.chart').each(function () {
      let a = $('.piechart-holder').data('skcolor')
      $('.chart').easyPieChart({
        barColor: a,
  ...
  // Background video ------------------
  let l = $('.background-youtube').data('vid')
  let m = $('.background-youtube').data('mv')
  $('.background-youtube').YTPlayer({
    ...
    mute: m,
    callback: function () {
      let a = $('.background-video').data('ytPlayer').player
    }
  })
  let vid = $('.background-vimeo').data('vim')
  ...
  function n() {
    ...
    let d = $('#portfolio_horizontal_container')
  ...
  let j = $('.portfolio_item , .gallery-item').length
  ...
  $.fn.duplicate = function (a, b) {
    let c = []
    for (let d = 0; d < a; d++) $.merge(c, this.clone(b).get())
...
function initHeader () {
  ...
  // Mobile bavigation   ------------------
  let nb = $('.nav-button'), nh = $('.nav-holder')
...
$(document).ready(function () {
  document.getElementById('trigger-page').addEventListener('click', function () {
    initMonolit()
    initparallax()
    contanimshow()
  })
  document.getElementById('trigger-header').addEventListener('click', function () {
    initHeader()
  })
})
